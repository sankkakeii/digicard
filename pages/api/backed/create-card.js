...
const apiRoute = async (req, res) => {
    ...
    const id = `${card_id}`;
    // const ext_card_url = `http://localhost:3000/cards/${id}`;
    const ext_card_url = `https://digicard-eta.vercel.app/cards/${id}`;
    ...
    try {
        ...
        res.status(200).json({ success: true, message: 'Digital Business Card created successfully', card_url: ext_card_url });
    } catch (error) {
